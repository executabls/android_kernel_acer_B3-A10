...
#define DW9814AFIOC_T_MOVETO _IOW(DW9814AF_MAGIC,1,unsigned long)

#define DW9814AFIOC_T_SETINFPOS _IOW(DW9814AF_MAGIC,2,unsigned long)

#define DW9814AFIOC_T_SETMACROPOS _IOW(DW9814AF_MAGIC,3,unsigned long)
#ifdef LensdrvCM3
