...
static void GC2355MIPI_Sensor_Init(void)
{
	...
	///////////////    ANALOG & CISCTL    ///////////////
	/////////////////////////////////////////////////////
	GC2355MIPI_write_cmos_sensor(0x03,0x04); 
	GC2355MIPI_write_cmos_sensor(0x04,0x88); 
	GC2355MIPI_write_cmos_sensor(0x05,0x01);
	GC2355MIPI_write_cmos_sensor(0x06,0x22);
	GC2355MIPI_write_cmos_sensor(0x07,0x00);
	GC2355MIPI_write_cmos_sensor(0x08,0x0b);
	...
	//////////////////////   crop   /////////////////////
	/////////////////////////////////////////////////////
	GC2355MIPI_write_cmos_sensor(0x92,0x02);//03
	GC2355MIPI_write_cmos_sensor(0x94,0x00);//01
...
#endif		
	//cam_adc = IMM_GetOneChannelValue(0,data,0); //pin:AUX_YP=14 niyangadd
      // printk("[++++GC2355_adc++++] data0: %d , data1 = %d\n", data[0],data[1]);
       if(*sensorID == GC2355_SENSOR_ID){//huaquan:data[0] ==0,qunhui:data[0] ==1
               return ERROR_NONE;  
       }else{
               *sensorID = 0xFFFFFFFF; 
		return ERROR_SENSOR_CONNECT_FAIL;
