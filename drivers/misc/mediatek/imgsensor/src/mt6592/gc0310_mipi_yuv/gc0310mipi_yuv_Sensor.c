...
SENSOR_EXIF_INFO_STRUCT GC0310MIPIExifInfo;
...
kal_uint16 GC0310MIPI_Read_Shutter(void)
{
	...
	printk("GC0310MIPIExifInfo shutter=%d,step=%d,shutter_iso=%d",shutter,step,shutter_iso);
	if(shutter_iso<33)
		shutter_iso = 33;
	GC0310MIPIExifInfo.CapExposureTime=shutter_iso;
	GC0310MIPI_write_cmos_sensor(0xfe,0x00);
	t_gain= GC0310MIPI_read_cmos_sensor(0xef);
	printk("GC0310MIPIExifInfo t_gain=%d\n",t_gain);
	if (t_gain >0xd0)
		GC0310MIPIExifInfo.RealISOValue = AE_ISO_100;
	else if (t_gain >0x70)
		GC0310MIPIExifInfo.RealISOValue = AE_ISO_200;
	else if (t_gain >0x20)
		GC0310MIPIExifInfo.RealISOValue = AE_ISO_400;
	else
		GC0310MIPIExifInfo.RealISOValue = AE_ISO_800;
	return shutter;
} /* GC0310MIPI_read_shutter */
...
void GC0310MIPIGammaSelect(kal_uint32 GammaLvl)
{
	...
	GC0310MIPI_write_cmos_sensor(0xfe,0x00);		
	GC0310MIPI_write_cmos_sensor(0xbf,0x02);
	GC0310MIPI_write_cmos_sensor(0xc0,0x0f);
	GC0310MIPI_write_cmos_sensor(0xc1,0x30);
	GC0310MIPI_write_cmos_sensor(0xc2,0x41);
	...
	GC0310MIPI_write_cmos_sensor(0xcc,0xeb);
	GC0310MIPI_write_cmos_sensor(0xcd,0xf2);
	GC0310MIPI_write_cmos_sensor(0xce,0xf6);
	GC0310MIPI_write_cmos_sensor(0xcf,0xf9);
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x17,0x17);//txr 7.21 17
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x41,0x25);//25->21->25
...
///////////////////   DNDD  /////////////////////
///////////////////////////////////////////////// 
	GC0310MIPI_write_cmos_sensor(0x82 ,0x18);//14 
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0xbf ,0x02);
	GC0310MIPI_write_cmos_sensor(0xc0 ,0x0a);
	GC0310MIPI_write_cmos_sensor(0xc1 ,0x25);
	GC0310MIPI_write_cmos_sensor(0xc2 ,0x40);
	GC0310MIPI_write_cmos_sensor(0xc3 ,0x59);
	GC0310MIPI_write_cmos_sensor(0xc4 ,0x6e);
	GC0310MIPI_write_cmos_sensor(0xc5 ,0x81);
	GC0310MIPI_write_cmos_sensor(0xc6 ,0x9f);
	GC0310MIPI_write_cmos_sensor(0xc7 ,0xb8);
	GC0310MIPI_write_cmos_sensor(0xc8 ,0xc6);
	GC0310MIPI_write_cmos_sensor(0xc9 ,0xd1);
	GC0310MIPI_write_cmos_sensor(0xca ,0xdb);
	GC0310MIPI_write_cmos_sensor(0xcb ,0xe2);
	GC0310MIPI_write_cmos_sensor(0xcc ,0xeb);
	GC0310MIPI_write_cmos_sensor(0xcd ,0xf2);
	GC0310MIPI_write_cmos_sensor(0xce ,0xf6);
	GC0310MIPI_write_cmos_sensor(0xcf ,0xf9);
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0xd1 ,0x2a);//34 
	GC0310MIPI_write_cmos_sensor(0xd2 ,0x2a);//34 
	...
	GC0310MIPI_write_cmos_sensor(0xde ,0xe2);//e5
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x0c,0x40); //00 txr 7.21
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x67,0x84);//82//e4->84 
	GC0310MIPI_write_cmos_sensor(0x69,0x10);//08->10
	GC0310MIPI_write_cmos_sensor(0x6a,0x25);
	GC0310MIPI_write_cmos_sensor(0x6b,0x00);//01 
	GC0310MIPI_write_cmos_sensor(0x6c,0x00); 
	GC0310MIPI_write_cmos_sensor(0x6d,0x02); 
	GC0310MIPI_write_cmos_sensor(0x6e,0x00); //f0->c0->00
	GC0310MIPI_write_cmos_sensor(0x6f,0xf0); //80->60->f0

	GC0310MIPI_write_cmos_sensor(0x76,0x80);
	GC0310MIPI_write_cmos_sensor(0x77,0x58);
	GC0310MIPI_write_cmos_sensor(0x78,0xc0); 
	...
	GC0310MIPI_write_cmos_sensor(0x95,0x20);
	GC0310MIPI_write_cmos_sensor(0x96,0x00);
	GC0310MIPI_write_cmos_sensor(0x97,0x3d);
	GC0310MIPI_write_cmos_sensor(0x98,0x2a);
	GC0310MIPI_write_cmos_sensor(0x9a,0x46);
	GC0310MIPI_write_cmos_sensor(0x9b,0x36);
	GC0310MIPI_write_cmos_sensor(0x9c,0x96);
	GC0310MIPI_write_cmos_sensor(0x9d,0x47);
	GC0310MIPI_write_cmos_sensor(0x9f,0x00);
	GC0310MIPI_write_cmos_sensor(0xa0,0x00);
	...
	GC0310MIPI_write_cmos_sensor(0xa7,0x9a);
	GC0310MIPI_write_cmos_sensor(0xa9,0xbb);
	GC0310MIPI_write_cmos_sensor(0xaa,0x9a);
	GC0310MIPI_write_cmos_sensor(0xab,0x97);
	GC0310MIPI_write_cmos_sensor(0xac,0x8a);
	GC0310MIPI_write_cmos_sensor(0xae,0xa9);
	GC0310MIPI_write_cmos_sensor(0xaf,0x98);
	GC0310MIPI_write_cmos_sensor(0xb0,0xcb);
	GC0310MIPI_write_cmos_sensor(0xb1,0x98);
	...
	GC0310MIPI_write_cmos_sensor(0xb8,0xc4);
	GC0310MIPI_write_cmos_sensor(0xb9,0xa4);
	
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
	GC0310MIPI_write_cmos_sensor(0x90,0xc9);
	GC0310MIPI_write_cmos_sensor(0x91,0xbe);
	GC0310MIPI_write_cmos_sensor(0x92,0xee);
	GC0310MIPI_write_cmos_sensor(0x93,0xca);
	GC0310MIPI_write_cmos_sensor(0x94,0x55);
	GC0310MIPI_write_cmos_sensor(0x95,0x21);
	GC0310MIPI_write_cmos_sensor(0x96,0xf0);
	...
	GC0310MIPI_write_cmos_sensor(0x9c,0x7c);
	...
	GC0310MIPI_write_cmos_sensor(0xa4,0xbe);
	...
	GC0310MIPI_write_cmos_sensor(0xa9,0xbe);
	GC0310MIPI_write_cmos_sensor(0xaa,0x95);
	GC0310MIPI_write_cmos_sensor(0xab,0xa7);
	GC0310MIPI_write_cmos_sensor(0xac,0x80);
	GC0310MIPI_write_cmos_sensor(0xad,0x55);
	GC0310MIPI_write_cmos_sensor(0xae,0xbe);
	GC0310MIPI_write_cmos_sensor(0xaf,0xa7);
	GC0310MIPI_write_cmos_sensor(0xb0,0xd2);
	...
	GC0310MIPI_write_cmos_sensor(0xfe,0x01);
	GC0310MIPI_write_cmos_sensor(0x76,0x70);
	GC0310MIPI_write_cmos_sensor(0x77,0x58);
	GC0310MIPI_write_cmos_sensor(0x78,0xbd);
	GC0310MIPI_write_cmos_sensor(0x79,0x80);//50 outdoor_r/g/b_limit
	GC0310MIPI_write_cmos_sensor(0x7a,0x58);
	GC0310MIPI_write_cmos_sensor(0x7b,0xb0);//46	
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0xd0 ,0x58);//46//guodengxiang
	GC0310MIPI_write_cmos_sensor(0xd1 ,0xf8);//ff fe
	GC0310MIPI_write_cmos_sensor(0xd2 ,0x04);//02
	GC0310MIPI_write_cmos_sensor(0xd3 ,0xec);//ff
	GC0310MIPI_write_cmos_sensor(0xd4 ,0x4e);//4a 50
	GC0310MIPI_write_cmos_sensor(0xd5 ,0xea);//fa

	GC0310MIPI_write_cmos_sensor(0xd6 ,0x48);//37
	GC0310MIPI_write_cmos_sensor(0xd7 ,0xee);//00
	GC0310MIPI_write_cmos_sensor(0xd8 ,0xf2);//07
	GC0310MIPI_write_cmos_sensor(0xd9 ,0x00);//2f
	GC0310MIPI_write_cmos_sensor(0xda ,0x4c);//4d
	GC0310MIPI_write_cmos_sensor(0xdb ,0xec);//e3
...
/////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0xc4 ,0x80);//40
	GC0310MIPI_write_cmos_sensor(0xc5 ,0x50);//30
	GC0310MIPI_write_cmos_sensor(0xc6 ,0x48);//30
	GC0310MIPI_write_cmos_sensor(0xc7 ,0x30);//10
	GC0310MIPI_write_cmos_sensor(0xc8,0x20); //00    //48
	GC0310MIPI_write_cmos_sensor(0xc9,0x20); //00    //40
...
//////////////	Measure Window	  ///////////////
/////////////////////////////////////////////////
	GC0310MIPI_write_cmos_sensor(0xcc ,0x08);//0c 
	GC0310MIPI_write_cmos_sensor(0xcd ,0x08);//10
	GC0310MIPI_write_cmos_sensor(0xce ,0xa6);//a0
	GC0310MIPI_write_cmos_sensor(0xcf ,0xee);//e6
...
//////////////////banding//////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x06 ,0x32); //HB
	GC0310MIPI_write_cmos_sensor(0x07,0x00); 
	GC0310MIPI_write_cmos_sensor(0x08 ,0x10); //VB
	GC0310MIPI_write_cmos_sensor(0xfe,0x01); 
	GC0310MIPI_write_cmos_sensor(0x25,0x00);  //step 
	GC0310MIPI_write_cmos_sensor(0x26 ,0x96); 
	GC0310MIPI_write_cmos_sensor(0x27 ,0x01); //30fps
	GC0310MIPI_write_cmos_sensor(0x28 ,0xc2);  
	...
	GC0310MIPI_write_cmos_sensor(0x2c ,0xdc); 
...
BOOL GC0310MIPI_set_Edge(UINT16 para)
{
	...
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		...
		case ISP_EDGE_LOW: 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0x95, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		break;
...
BOOL GC0310MIPI_set_Brightness(UINT16 para)
{
	...
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xd5, 0x10); 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x01); 
	...
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		...
		case ISP_BRIGHT_LOW: 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xd5, 0xf8); 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x01); 
...
BOOL GC0310MIPI_set_Contrast(UINT16 para)
{
	...
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xd3, 0x40);//40 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		break;
		
		case ISP_CONTRAST_HIGH: 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xd3, 0x50); 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		break;
...
BOOL GC0310MIPI_set_Saturation(UINT16 para)
{
	...
	{	
		case ISP_SAT_MIDDLE:
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xd1, 0x2a);//36 
	GC0310MIPI_write_cmos_sensor(0xd2, 0x2a);//36 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		break;
		
		case ISP_SAT_HIGH: 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xd1, 0x40); 
	GC0310MIPI_write_cmos_sensor(0xd2, 0x40); 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		break;
		
		case ISP_SAT_LOW: 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0xd1, 0x10); 
	GC0310MIPI_write_cmos_sensor(0xd2, 0x10); 	
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
		break;
...
BOOL GC0310MIPI_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			GC0310MIPI_write_cmos_sensor(0x77, 0x8a); //WB_manual_gain 
			GC0310MIPI_write_cmos_sensor(0x78, 0x42);
			GC0310MIPI_write_cmos_sensor(0x79, 0x60);
		break;
		
		case AWB_MODE_DAYLIGHT: //sunny
			GC0310MIPI_awb_enable(KAL_FALSE);
			GC0310MIPI_write_cmos_sensor(0x77, 0x8a); 
			GC0310MIPI_write_cmos_sensor(0x78, 0x42);
		...
		case AWB_MODE_INCANDESCENT: //office
			GC0310MIPI_awb_enable(KAL_FALSE);
			GC0310MIPI_write_cmos_sensor(0x77, 0x70);
			GC0310MIPI_write_cmos_sensor(0x78, 0x40);
			GC0310MIPI_write_cmos_sensor(0x79, 0x90);
		break;
		...
		case AWB_MODE_FLUORESCENT:
			...
			GC0310MIPI_write_cmos_sensor(0x78, 0x42);
			GC0310MIPI_write_cmos_sensor(0x79, 0x78);
		break;
...
BOOL GC0310MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0310MIPI_write_cmos_sensor(0x26, 0x96);   //anti-flicker step [7:0]
			
			GC0310MIPI_write_cmos_sensor(0x27, 0x01);   //exp level 0  20fps
			GC0310MIPI_write_cmos_sensor(0x28, 0xc2); 
		...
		case AE_FLICKER_MODE_60HZ:
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
			GC0310MIPI_write_cmos_sensor(0x05, 0x01); 	
			GC0310MIPI_write_cmos_sensor(0x06, 0x32); 
			GC0310MIPI_write_cmos_sensor(0x07, 0x00);
			GC0310MIPI_write_cmos_sensor(0x08, 0x10);
			
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x25, 0x00);   //anti-flicker step [11:8]
			GC0310MIPI_write_cmos_sensor(0x26, 0x7d);   //anti-flicker step [7:0]
			
			GC0310MIPI_write_cmos_sensor(0x27, 0x01);   //exp level 0  20fps
			GC0310MIPI_write_cmos_sensor(0x28, 0x77); 
			GC0310MIPI_write_cmos_sensor(0x29, 0x02);   //exp level 1  13fps
			GC0310MIPI_write_cmos_sensor(0x2a, 0xee); 
			GC0310MIPI_write_cmos_sensor(0x2b, 0x05);   //exp level 2  7.5fps
			GC0310MIPI_write_cmos_sensor(0x2c, 0xdc); 
			GC0310MIPI_write_cmos_sensor(0x2d, 0x07);   //exp level 3  5.45fps
			GC0310MIPI_write_cmos_sensor(0x2e, 0x53); 
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
...
void GC0310MIPIGetAFMaxNumFocusAreas(UINT32 *pFeatureReturnPara32)
{
	*pFeatureReturnPara32 = 0;
	SENSORDB("GC0310MIPIGetAFMaxNumFocusAreas, *pFeatureReturnPara32 = %d\n",
		 *pFeatureReturnPara32);
}

void GC0310MIPIGetAFMaxNumMeteringAreas(UINT32 *pFeatureReturnPara32)
{
	*pFeatureReturnPara32 = 0;
	SENSORDB("GC0310MIPIGetAFMaxNumMeteringAreas,*pFeatureReturnPara32 = %d\n",
		 *pFeatureReturnPara32);
}

void GC0310MIPIGetExifInfo(UINT32 exifAddr)
{
	SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
	GC0310MIPI_Read_Shutter();
	pExifInfo->RealISOValue = GC0310MIPIExifInfo.RealISOValue;
	pExifInfo->CapExposureTime = GC0310MIPIExifInfo.CapExposureTime*1000;
	printk("GC0310MIPIExifInfo.CapExposureTime is %d",GC0310MIPIExifInfo.CapExposureTime);
}
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
		GC0310MIPIGetAFMaxNumFocusAreas(pFeatureReturnPara32);
		*pFeatureParaLen = 4;
		break;
	case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
		GC0310MIPIGetAFMaxNumMeteringAreas(pFeatureReturnPara32);
		*pFeatureParaLen = 4;
		break;
		/*
	case SENSOR_FEATURE_SET_TEST_PATTERN:
		GC0310MIPI_SetTestPatternMode((BOOL) *pFeatureData16);
		break;
	...
	case SENSOR_FEATURE_GET_EXIF_INFO:
		GC0310MIPIGetExifInfo(*pFeatureData32);
		break;
    default:
        break;
	}
