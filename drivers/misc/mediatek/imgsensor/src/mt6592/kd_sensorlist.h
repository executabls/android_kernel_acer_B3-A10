...
UINT32 HI545_QH_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(HI545_QH_MIPI_RAW)
		{HI545_QH_MIPI_SENSOR_ID, SENSOR_DRVNAME_HI545_QH_MIPI_RAW, HI545_QH_MIPI_RAW_SensorInit},
#endif
